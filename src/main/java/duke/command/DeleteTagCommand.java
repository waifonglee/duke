...
public class DeleteTagCommand extends Command {
    ...
    private static final String MESSAGE_INVALID_FORMAT = "Invalid input: deltag (valid task num) (1 tag only)";
    ...
    private Task delTag(TaskList tasks, String[] args) throws DukeException, NumberFormatException {
